...
//     worksheet.addRow({ project: projectKey, type: type });
...
//     if (bugs.length > 0) addIssuesToWorksheet(bugs, "BUG", projectKey);
...
//S E C O N D V E R S I O N================================================================================== S E C O N D V E R S I O N//
// const axios = require("axios");
// const ExcelJS = require("exceljs");
